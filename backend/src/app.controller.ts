    ...
    <main>
      <section class="card">
        ...
        <ul>
          ...
          <li>카드뉴스 조회 기록</li>
          <li>서비스 이용 분석 이벤트</li>
          <li>인증 감사 기록은 개인 식별 정보 제거 후 보존될 수 있음</li>
        </ul>
        <h2>처리 안내</h2>
        <p>삭제 요청 확인 후 관련 계정 데이터는 삭제됩니다. 탈퇴 처리 이력은 개인 식별 정보를 제거한 감사 기록으로 보존될 수 있으며, 법령상 보존이 필요한 정보는 해당 법령에서 정한 기간 동안만 보관합니다.</p>
